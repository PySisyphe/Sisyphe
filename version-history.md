...
version 0.9.1, build 05/08/2025
-------------------------------
...
**upgrade external module**
	pydicom, upgrade 2.3.1 to 3.0.1
		generate a bug in core.sisypheDicom.ImportFromRTStruct.execute() method (see bug fix in update method)
**update module**
	core.sisypheDicom
	gui.dialogSplash
...
**update method**
	core.sisypheDicom.ImportFromRTStruct.execute()
		bug fix, since version 3.0.1, the VM attribute of a sequence (SQ) is always 1, 
...
**update function**
	core.sisypheImageIO.isDicom
		bug fix, return value correction, str to bool

version 0.9.1, build 28/08/2025
-------------------------------
