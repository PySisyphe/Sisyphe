...
|slice-view|
	Display the selected volume of the thumbnail bar (blue border, reference volume) in the slice view. If no thumbnail is selected, the first volume to the left of the thumbnail bar is selected displayed in the slice view. You can also select thumbail popup menu **Display in slice view**, or press **F1** key.

|ortho-view|
	Display the selected volume of the thumbnail bar (blue border, reference volume) in the orthogonal view. If no thumbnail is selected, the first volume to the left of the thumbnail bar is selected and displayed in the orthogonal view. You can also select thumbail popup menu **Display in orthogonal view**, or press **F2** key.

|sync-view|
	Display the selected volume of the thumbnail bar (blue border, reference volume) in the synchronized view. If no thumbnail is selected, the first volume to the left of the thumbnail bar is selected and displayed in the synchronized view. You can also select thumbail popup menu **Display in synchronized view**, or press **F3** key.

|proj-view|
	Display the selected volume of the thumbnail bar (blue border, reference volume) in the projection view. If no thumbnail is selected, the first volume to the left of the thumbnail bar is selected and displayed in the projection view. You can also select thumbail popup menu **Display in projection view**, or press **F4** key.

|multi-view|
	Display the selected volume of the thumbnail bar (blue border, reference volume) in the multi-component view. If no thumbnail is selected, the first volume to the left of the thumbnail bar is selected and displayed in the multi-component view. This viewer is assigned to multi-component volume (array image values are vectors, not scalar values). You can also select thumbail popup menu **Display in multi-component view**, or press **F5** key.

|hide-view|
	Close all views. No volume of the thumbnail bar is selected.
...
.. |multi-view| image:: /GUI/toolbar/multi-view.png
   :scale: 25 %
.. |hide-view| image:: /GUI/toolbar/hide.png
   :scale: 25 %
