...
This widget has a list box of selected files at the top, and three or four buttons at the bottom.
...
|left| button
	Left-click to display a menu that lists the volume(s) open in the :ref:`Thumbnail bar <page-thumbnailbar>`. This button is optional and will not always be visible.
...
**view box**
	Shows volume with overlaid ROI in red. Voxels of this ROI have a signal in the range of the thresholds defined in the threshold selection box, i.e. ROI is the result of volume thresholding. This view is updated in real time as thresholds change.
