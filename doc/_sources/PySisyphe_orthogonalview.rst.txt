...
|cursor|
	The cursor is drawn as three intersecting orthognal lines in the 3D renderer cell. It associates a sphere with the center projected onto the intersection of the three axis lines. Left-click to display a menu to select sphere visbility and radius.
...
|info|
	...
	- **Voxel overlay value**, overlay scalar value of voxel at mouse position. The current color bar becomes that of the selected overlay.
...
Right-click on a point to show a popup menu:
