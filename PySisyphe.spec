...
datas = [('Sisyphe/doc/*.*', 'Sisyphe/doc'),
         ...
         ('.venv/Lib/site-packages/dipy/data/files/*.*', 'dipy/data/files'),
         ('.venv/Lib/site-packages/deepbrain/models/*.*', 'deepbrain/models'),
         ('.venv/Lib/site-packages/itk_core.libs/tbb12.dll', 'itk_core.libs'),
         ('.venv/Lib/site-packages/itk/ITKBridgeNumPyPython.py','itk'),
         ('.venv/Lib/site-packages/itk/ITKCommonPython.py','itk'),
         ('.venv/Lib/site-packages/itk/ITKPyBasePython.py','itk'),
         ('.venv/Lib/site-packages/itk/support/__pycache__/build_options.pyc','itk/support'),
         ('.venv/Lib/site-packages/vtk.libs/*.dll','vtk.libs')]
