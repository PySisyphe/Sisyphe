...
from Sisyphe.lib.openmap.utils.make_csv import make_csv
from Sisyphe.lib.openmap.utils.make_level import create_parcellated_images
...
from Sisyphe.lib.openmap.utils.preprocessing import preprocessing
...
def main():
    ...
    try:
        ...
        cnet, ssnet, pnet, hnet = load_model(opt.m, device)
        print("Load complete !!")
